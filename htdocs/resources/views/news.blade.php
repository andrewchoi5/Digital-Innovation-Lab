      ...
      <div class="container">
       ...
       <?php include('../resources/views/menuBar.blade.php');?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-2 text-center"><button type="button" class="btn btn-md btn-primary" data-toggle="modal" data-target="" style="width:150px;text-align:left"><span class="glyphicon glyphicon-plus"></span> Share</button></div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-4">
                    <h3 class="subtitle">Volunteers Needed</h3>
                  </div>
                  <div class="col-md-6"></div>
                </div>
                <hr>
