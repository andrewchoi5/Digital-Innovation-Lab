...
<html>
    <head>
        <title>IBM Digital Innovation Lab - Chelsea Thiel-Jones</title>
...
<script>
     $("#demo-wrapper").load("index.php ." + "chelseathieljones", function() {
       $.getScript('collapse.js', function() { //leave it
        });
     });
     var title = "Chelsea Thiel-Jones Projects";
