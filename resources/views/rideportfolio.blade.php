...
<html>
    <head>
        <title>Ride Your Portfolio VR</title>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
    ...
    <body>
        ...
        <div class= "well">
          ...
          <a href="/downloadStockApp" target="_blank"><span class="btn btn-sm btn-success">Download APK 2MB</span></a>
          <h5> - Virtual Reality app APK</h5>
          <a href="/downloadPortfolioVR" target="_blank"><span class="btn btn-sm btn-success">Download APK 24.1MB</span></a>
  		</div>
      ...
      <h3><li>Source Code: </li></h3>
          <p>Android App: <a href="http://atldcyz082170.red.ihost.com/najafi/BlueAirline/tree/rollercoaster_android" target ="_blank">http://atldcyz082170.red.ihost.com/najafi/BlueAirline/tree/airline_android</a></p>
          <p>VR App: <a href="http://atldcyz082170.red.ihost.com/najafi/BlueAirline/tree/rollercoaster_vr" target ="_blank">http://atldcyz082170.red.ihost.com/najafi/BlueAirline/tree/seatselection_vr</a></p>
